...
namespace Org.BouncyCastle.Math.EC
{
	internal class LongArray
	{
		...
		public BigInteger ToBigInteger()
		{
			...
			{
				long num4 = this.m_ints[k];
				for (int l = 7; l >= 0; l--)
				{
					array2[num2++] = (byte)((ulong)num4 >> 8 * l);
				}
			}
		...
		public LongArray ModMultiplyAlt(LongArray other, int m, int[] ks)
		{
			...
			if (num4 != 1)
			{
				...
				while (--num24 > 1)
				{
					if (((long)num24 & 1L) == 0L)
					{
						LongArray.AddShiftedUp(array2, array[(int)((UIntPtr)((uint)num24 >> 1))], array2, array[num24], num6, num8);
					}
					else
					{
		...
		public LongArray ModSquare(int m, int[] ks)
		{
			...
			while (i < num)
			{
				long num2 = this.m_ints[(int)((UIntPtr)((uint)i >> 1))];
		...
		private static long Interleave3(long x)
		{
			...
			return num | LongArray.Interleave3_21to63((int)x & 2097151) | LongArray.Interleave3_21to63((int)((ulong)x >> 21) & 2097151) << 1 | LongArray.Interleave3_21to63((int)((ulong)x >> 42) & 2097151) << 2;
		}

		private static long Interleave3_21to63(int x)
		{
			int num = LongArray.INTERLEAVE3_TABLE[x & 127];
			int num2 = LongArray.INTERLEAVE3_TABLE[(int)((UIntPtr)((uint)x >> 7 & 127u))];
			int num3 = LongArray.INTERLEAVE3_TABLE[(int)((UIntPtr)((uint)x >> 14))];
			return ((long)num3 & (long)((ulong)-1)) << 42 | ((long)num2 & (long)((ulong)-1)) << 21 | ((long)num & (long)((ulong)-1));
		}
		...
		private static long Interleave3_13to65(int x)
		{
			...
			int num2 = LongArray.INTERLEAVE5_TABLE[(int)((UIntPtr)((uint)x >> 7))];
			return ((long)num2 & (long)((ulong)-1)) << 35 | ((long)num & (long)((ulong)-1));
		}
		...
		private static long Interleave4_16to64(int x)
		{
			...
			int num2 = LongArray.INTERLEAVE4_TABLE[(int)((UIntPtr)((uint)x >> 8))];
			return ((long)num2 & (long)((ulong)-1)) << 32 | ((long)num & (long)((ulong)-1));
		}

		private static long Interleave2_32to64(int x)
		{
			int num = (int)LongArray.INTERLEAVE2_TABLE[x & 255] | (int)LongArray.INTERLEAVE2_TABLE[(int)((UIntPtr)((uint)x >> 8 & 255u))] << 16;
			int num2 = (int)LongArray.INTERLEAVE2_TABLE[(int)((UIntPtr)((uint)x >> 16 & 255u))] | (int)LongArray.INTERLEAVE2_TABLE[(int)((UIntPtr)((uint)x >> 24))] << 16;
			return ((long)num2 & (long)((ulong)-1)) << 32 | ((long)num & (long)((ulong)-1));
		}
