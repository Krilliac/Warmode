...
namespace Org.BouncyCastle.Asn1.Sec
{
	public sealed class SecNamedCurves
	{
		...
		{
			SecNamedCurves.objIds.Add(Platform.ToLowerInvariant(name), oid);
		...
		{
			SecNamedCurves.objIds = Platform.CreateHashtable();
			SecNamedCurves.curves = Platform.CreateHashtable();
			SecNamedCurves.names = Platform.CreateHashtable();
		...
		{
			return (DerObjectIdentifier)SecNamedCurves.objIds[Platform.ToLowerInvariant(name)];
		}
