...
namespace Org.BouncyCastle.Asn1.TeleTrust
{
	public class TeleTrusTNamedCurves
	{
		...
		{
			TeleTrusTNamedCurves.objIds.Add(Platform.ToLowerInvariant(name), oid);
		...
		{
			TeleTrusTNamedCurves.objIds = Platform.CreateHashtable();
			TeleTrusTNamedCurves.curves = Platform.CreateHashtable();
			TeleTrusTNamedCurves.names = Platform.CreateHashtable();
		...
		{
			return (DerObjectIdentifier)TeleTrusTNamedCurves.objIds[Platform.ToLowerInvariant(name)];
		}
