...
namespace Org.BouncyCastle.Asn1.CryptoPro
{
	public sealed class ECGost3410NamedCurves
	{
		...
		{
			ECGost3410NamedCurves.objIds = Platform.CreateHashtable();
			ECGost3410NamedCurves.parameters = Platform.CreateHashtable();
			ECGost3410NamedCurves.names = Platform.CreateHashtable();
