...
namespace Org.BouncyCastle.Crypto.Engines
{
	public class ChaChaEngine : Salsa20Engine
	{
		...
		protected override void SetKey(byte[] keyBytes, byte[] ivBytes)
		{
			...
			this.engineState[8] = Pack.LE_To_UInt32(keyBytes, num);
			this.engineState[9] = Pack.LE_To_UInt32(keyBytes, num + 4);
			this.engineState[10] = Pack.LE_To_UInt32(keyBytes, num + 8);
			this.engineState[11] = Pack.LE_To_UInt32(keyBytes, num + 12);
