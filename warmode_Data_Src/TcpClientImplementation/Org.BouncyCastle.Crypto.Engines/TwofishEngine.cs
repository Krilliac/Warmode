...
namespace Org.BouncyCastle.Crypto.Engines
{
	public sealed class TwofishEngine : IBlockCipher
	{
		...
		public TwofishEngine()
		{
			...
			for (int i = 0; i < 256; i++)
			{
				int num = (int)(TwofishEngine.P[0, i] & 255);
				array[0] = num;
				array2[0] = (this.Mx_X(num) & 255);
				array3[0] = (this.Mx_Y(num) & 255);
				num = (int)(TwofishEngine.P[1, i] & 255);
				array[1] = num;
		...
		private void SetKey(byte[] key)
		{
			...
			while (k < 256)
			{
				...
				{
				case 0:
					num6 = ((int)(TwofishEngine.P[1, num6] & 255) ^ this.M_b0(x4));
					num5 = ((int)(TwofishEngine.P[0, num5] & 255) ^ this.M_b1(x4));
					num7 = ((int)(TwofishEngine.P[0, num7] & 255) ^ this.M_b2(x4));
					num8 = ((int)(TwofishEngine.P[1, num8] & 255) ^ this.M_b3(x4));
					goto IL_2AD;
				case 1:
					this.gSBox[k * 2] = this.gMDS0[(int)(TwofishEngine.P[0, num6] & 255) ^ this.M_b0(x)];
					this.gSBox[k * 2 + 1] = this.gMDS1[(int)(TwofishEngine.P[0, num5] & 255) ^ this.M_b1(x)];
					this.gSBox[k * 2 + 512] = this.gMDS2[(int)(TwofishEngine.P[1, num7] & 255) ^ this.M_b2(x)];
					this.gSBox[k * 2 + 513] = this.gMDS3[(int)(TwofishEngine.P[1, num8] & 255) ^ this.M_b3(x)];
					break;
				case 2:
					goto IL_325;
				case 3:
				...
				continue;
				IL_325:
				this.gSBox[k * 2] = this.gMDS0[(int)(TwofishEngine.P[0, (int)(TwofishEngine.P[0, num6] & 255) ^ this.M_b0(x2)] & 255) ^ this.M_b0(x)];
				this.gSBox[k * 2 + 1] = this.gMDS1[(int)(TwofishEngine.P[0, (int)(TwofishEngine.P[1, num5] & 255) ^ this.M_b1(x2)] & 255) ^ this.M_b1(x)];
				this.gSBox[k * 2 + 512] = this.gMDS2[(int)(TwofishEngine.P[1, (int)(TwofishEngine.P[0, num7] & 255) ^ this.M_b2(x2)] & 255) ^ this.M_b2(x)];
				this.gSBox[k * 2 + 513] = this.gMDS3[(int)(TwofishEngine.P[1, (int)(TwofishEngine.P[1, num8] & 255) ^ this.M_b3(x2)] & 255) ^ this.M_b3(x)];
				goto IL_453;
				IL_2AD:
				num6 = ((int)(TwofishEngine.P[1, num6] & 255) ^ this.M_b0(x3));
				num5 = ((int)(TwofishEngine.P[1, num5] & 255) ^ this.M_b1(x3));
				num7 = ((int)(TwofishEngine.P[0, num7] & 255) ^ this.M_b2(x3));
				num8 = ((int)(TwofishEngine.P[0, num8] & 255) ^ this.M_b3(x3));
				goto IL_325;
			}
		}
		...
		private int F32(int x, int[] k32)
		{
			...
			{
			case 0:
				num = ((int)(TwofishEngine.P[1, num] & 255) ^ this.M_b0(x5));
				num2 = ((int)(TwofishEngine.P[0, num2] & 255) ^ this.M_b1(x5));
				num3 = ((int)(TwofishEngine.P[0, num3] & 255) ^ this.M_b2(x5));
				num4 = ((int)(TwofishEngine.P[1, num4] & 255) ^ this.M_b3(x5));
				break;
			case 1:
				result = (this.gMDS0[(int)(TwofishEngine.P[0, num] & 255) ^ this.M_b0(x2)] ^ this.gMDS1[(int)(TwofishEngine.P[0, num2] & 255) ^ this.M_b1(x2)] ^ this.gMDS2[(int)(TwofishEngine.P[1, num3] & 255) ^ this.M_b2(x2)] ^ this.gMDS3[(int)(TwofishEngine.P[1, num4] & 255) ^ this.M_b3(x2)]);
				return result;
			case 2:
				goto IL_1CF;
			case 3:
			...
			num = ((int)(TwofishEngine.P[1, num] & 255) ^ this.M_b0(x4));
			num2 = ((int)(TwofishEngine.P[1, num2] & 255) ^ this.M_b1(x4));
			num3 = ((int)(TwofishEngine.P[0, num3] & 255) ^ this.M_b2(x4));
			num4 = ((int)(TwofishEngine.P[0, num4] & 255) ^ this.M_b3(x4));
			IL_1CF:
			result = (this.gMDS0[(int)(TwofishEngine.P[0, (int)(TwofishEngine.P[0, num] & 255) ^ this.M_b0(x3)] & 255) ^ this.M_b0(x2)] ^ this.gMDS1[(int)(TwofishEngine.P[0, (int)(TwofishEngine.P[1, num2] & 255) ^ this.M_b1(x3)] & 255) ^ this.M_b1(x2)] ^ this.gMDS2[(int)(TwofishEngine.P[1, (int)(TwofishEngine.P[0, num3] & 255) ^ this.M_b2(x3)] & 255) ^ this.M_b2(x2)] ^ this.gMDS3[(int)(TwofishEngine.P[1, (int)(TwofishEngine.P[1, num4] & 255) ^ this.M_b3(x3)] & 255) ^ this.M_b3(x2)]);
			return result;
		}
		...
		{
			return (int)(b[p] & 255) | (int)(b[p + 1] & 255) << 8 | (int)(b[p + 2] & 255) << 16 | (int)(b[p + 3] & 255) << 24;
		}
