...
namespace RootMotion.FinalIK
{
	...
	public class GrounderBipedIK : Grounder
	{
		...
		private void Initiate()
		{
			...
			IKSolverFABRIK expr_84 = this.ik.solvers.spine;
			expr_84.OnPreUpdate = (IKSolver.UpdateDelegate)Delegate.Combine(expr_84.OnPreUpdate, new IKSolver.UpdateDelegate(this.OnSolverUpdate));
			IKSolverLimb expr_B5 = this.ik.solvers.rightFoot;
			expr_B5.OnPostUpdate = (IKSolver.UpdateDelegate)Delegate.Combine(expr_B5.OnPostUpdate, new IKSolver.UpdateDelegate(this.OnPostSolverUpdate));
