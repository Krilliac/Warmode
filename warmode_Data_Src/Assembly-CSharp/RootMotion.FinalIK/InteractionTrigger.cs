...
namespace RootMotion.FinalIK
{
	...
	public class InteractionTrigger : MonoBehaviour
	{
		...
		public class CharacterPosition
		{
			...
			[Range(-180f, 180f), Tooltip("Angle offset from the default forward direction..")]
			public float angleOffset;

			[Range(0f, 180f), Tooltip("Max angular offset of the character's forward from the direction of this trigger.")]
			...
			public bool IsInRange(Transform character, Transform trigger, out float error)
			{
				...
				if (this.orbit)
				{
					Vector3 forward2 = vector2 - trigger.position;
					Quaternion rotation2 = Quaternion.LookRotation(forward2, vector);
		...
		public class CameraPosition
		{
			...
			[Range(0f, 180f), Tooltip("Max angle between the direction and the direction towards the camera.")]
			public float maxAngle = 45f;
