...
public class glareFxChromatic : MonoBehaviour
{
	...
	public Vector3 chromaticDistortion = new Vector3(-0.04f, 0f, 0.04f);
	...
	private void OnRenderImage(RenderTexture source, RenderTexture dest)
	{
		...
		this.haloIntensity = Mathf.Clamp(this.haloIntensity, 0f, 10f);
		this.GetMaterial().SetFloat("_int", this.intensity);
		this.GetMaterial().SetVector("_chromatic", this.chromaticDistortion);
		...
		this.GetMaterial().SetFloat("_haloint", this.haloIntensity);
