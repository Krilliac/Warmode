			...
			for (int i = 0; i <= max_code; i++)
			{
				...
				if (++num3 >= num4 || num6 != num2)
				{
					...
					else if (num6 != 0)
					{
						if (num6 != num)
						{
							short[] expr_9B_cp_0 = this.bl_tree;
							int expr_9B_cp_1 = num6 * 2;
							expr_9B_cp_0[expr_9B_cp_1] += 1;
						}
						short[] expr_B3_cp_0 = this.bl_tree;
						int expr_B3_cp_1 = InternalConstants.REP_3_6 * 2;
						expr_B3_cp_0[expr_B3_cp_1] += 1;
					}
					else if (num3 <= 10)
					{
						short[] expr_D9_cp_0 = this.bl_tree;
						int expr_D9_cp_1 = InternalConstants.REPZ_3_10 * 2;
						expr_D9_cp_0[expr_D9_cp_1] += 1;
					}
					else
					{
						short[] expr_F6_cp_0 = this.bl_tree;
						int expr_F6_cp_1 = InternalConstants.REPZ_11_138 * 2;
